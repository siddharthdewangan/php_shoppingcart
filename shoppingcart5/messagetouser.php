...
<?php
include("datalink.php");
$select=mysql_query("select * from msg where cid='0'");
?>
...
$row2=mysql_fetch_array($rscid);
$origcid=$row2['cid'];
$rsmsg=mysql_query("select * from msg where cid='$origcid'");

	while($row3=mysql_fetch_array($rsmsg))
	{
		$mid2=$row3['mid'];
		$message2=$row3['message'];
