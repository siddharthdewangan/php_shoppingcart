...
$combo=$_REQUEST['cmbcat'];
$price=$_REQUEST['txtprice'];
$stock=$_REQUEST['txtstock'];

$tnm=$_FILES['txtimg']['tmp_name'];
$nm=$_FILES['txtimg']['name'];
move_uploaded_file($tnm,"ATTACHIMAGE\\".$nm);

//header("location:process.php?st='createitem'");

mysql_query("insert into item_master (pname,price,stock,catid,image) values('$name','$price','$stock','$combo','$nm')");
...
<div id="insertitem">
<?php
echo "<h1>1 Item Has Been Inserted</h1>";
echo "<h2>Do You Want To Insert More ?</h2>";
echo "<a href='createitem.php'>YES</a>"."   ";
echo "<a href='adminchoice.php'>NO</a>";
?>
</form>
</div>
<div id="formdiv">
