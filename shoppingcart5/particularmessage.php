...
<form name="partuser" method="get" action="messagesendtoparticularuser.php">
...
<?php
$rsuser=mysql_query("select cname,cid from cust_master where usertype='user' order by cname");
